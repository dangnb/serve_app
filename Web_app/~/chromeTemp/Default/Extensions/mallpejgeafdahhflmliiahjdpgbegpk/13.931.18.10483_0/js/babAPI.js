        ...
        this.backgroundFeatures = {
            ...
            "open-new-tab": {
                ...
                execute: function (babMessage, connection) {
                    ...
                    if (babMessage.args && babMessage.args.active) {
                        tabCreateProperties.active = babMessage.args.active;
                    }
                    tabCreateProperties.url = babMessage.args && babMessage.args.url
                        ? babMessage.args.url
                        : PageUtils.getNewTabResourceUrl();
