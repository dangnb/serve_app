...
var UrlUtils;
(function (UrlUtils) {
    UrlUtils.urlProtocolRegex = /^https?:/i;
    UrlUtils.urlParamsRegex = /\?.*$/i;
    ...
    function appendParamsFromObject(url, params) {
        var resultUrl = url;
        Object.keys(params).forEach(function (param) {
            if (params[param] || params[param] === "") {
                resultUrl = appendParamToUrl(resultUrl, param, params[param]);
            }
        });
        return resultUrl;
    }
    UrlUtils.appendParamsFromObject = appendParamsFromObject;
})(UrlUtils || (UrlUtils = {}));
